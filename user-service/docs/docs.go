    ...
    "paths": {
        ...
        "/auth/profile": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Update Data User Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateDataUserRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/profile/password": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Update Profile Password Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateProfilePasswordRequest"
                        }
                    }
                ],
                "responses": {
